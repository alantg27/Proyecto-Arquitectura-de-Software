...
public class DashboardNumeroActividadesCuadrilla extends JFrame {
    // Constructor de la clase JFrame
    public DashboardNumeroActividadesCuadrilla() {
        // Configuración básica de la ventana
        setTitle("Dashboard - Actividades por Cuadrilla");
        setSize(800, 600);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Solo cierra este JFrame
...
class ChartPanel extends JPanel {
    ...
    private void loadData() {
        try {
            ...
            while (rs.next()) {
                ...
                data.put(idCuadrilla, numActividades);
            }
    ...
    private void drawBarChart(Graphics2D g2d) {
        ...
        String xLabel = "Id de cuadrillas";
        ...
        for (Map.Entry<Integer, Integer> entry : data.entrySet()) {
            ...
            // Dibujar etiquetas
            g2d.setColor(Color.BLACK);
            g2d.drawString(String.valueOf(idCuadrilla), xPosition + 10, padding + chartHeight + 15);
